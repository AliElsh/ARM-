...
#define PORTB    		   1
#define PORTC     		   2
/* YOU CAN CHOICE OUTPUT -> HIGH OR LOW  FROM THIS
 * ODR REG
 *   */
#define HIGH               1
#define LOW                0
...
#define AF          	   0b10
#define ANALOG      	   0b11
/* IF YOU CHOICE OUTPUT YOU CAN CHOICE OUTPUT WHAT FROM THIS
 * OTYPE REG
 *   */
#define PUSH_PULL          0
#define OPEN_DRAIN   	   1
/* YOU CAN CHOICE SPEED
 * OSPEED REG
 *  */
...
/* IF YOU CHOICE INPUT YOU CAN CHOICE INPUT WHAT FROM THIS
 * PUPD REG
 * */
#define PULL_UP            0b01
#define PULL_DOWN          0b10
#define FLOATING           0b00
/* IF YOU CHOICE AF YOU CAN CHOICE AF WHAT FROM THIS
 * AFRL & AFRH REG
 * */
#define  AF0  0b0000
#define  AF1  0b0001
